...
var RelationshipWidget = (function () {
    ...
    RelationshipWidget = __decorate([
        core_1.Component({
            ...
            directives: [view_relationGraph_1.RelationshipGraph, view_relationTree_1.RelationshipTree, dropdown_1.DROPDOWN_DIRECTIVES, common_1.CORE_DIRECTIVES, toolbar_propertySettings_1.PropertyToolbar]
        }), 
